...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/', [App\Http\Controllers\HomeController::class, 'doDecision'])->name('home');
    Route::get('/home', [App\Http\Controllers\HomeController::class, 'doDecision'])->name('home');
...
Route::get('/tests', [HomeController::class, 'serverTests'])->name('test');
